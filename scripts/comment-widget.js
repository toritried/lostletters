...
const s_stylePath = '/styles/comment-widget.css'; // Define the path for the stylesheet (ie. /styles/commentwidget.css)
const s_formId = '1FAIpQLSdBkHzag4aINe8qjsrQPnVhCcHENze29YW3F3VVANvB2WDJ2w'; // The Google Form
...
const s_timezone = +9; // Your personal timezone (Example: UTC-5:00 is -5 here, UTC+10:30 would be 10.5)
...
const s_commentsPerPage = 20; // The max amount of comments that can be displayed on one page, any number >= 1 (Replies not counted)
...
const s_widgetTitle = 'Send a Letter';
