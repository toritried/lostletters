...
<br>
<br>
Additionally, the player community around Ironsworn is simply the best. They've created resources like <a target="_blank" href="https://nboughton.uk/apps/ironsworn-campaign/#/">Ironjournal</a>, which is a web app I use to easily play the game without having to click around in the PDF to read all the moves and how to resolve them. I highly recommend using this for solo-play.  
<br>
